...
import { Pagination, Input } from "daisyui-vue";
import { ICertType, FnLoad } from "../../types";

// props
const props = defineProps<{
  load_data: FnLoad<ICertType>;
  forceReload: boolean;
  searchKind: number;
}>();
...
watch([page, size, () => props.forceReload, ], (value, oldvalue) => {
  will_load.value++;
});
