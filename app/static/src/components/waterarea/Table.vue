...
import { IWaterarea, FnLoad, FnDelete } from "../../types";

// props
const props = defineProps<{
  load_data: FnLoad<IWaterarea>;
  forceReload: boolean;
}>();
...
let items = ref<Array<IWaterarea>>([]);
